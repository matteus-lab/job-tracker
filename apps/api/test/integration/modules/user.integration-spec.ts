...
import { IUSER_REPOSITORY_TOKEN } from 'src/modules/user/user.repository.interface';
import { UUID_V4_REGEX } from 'test/constants/regex.constants';
import { UserWithPasswordEntity } from 'src/modules/user/schemas/entities/userWithPassword.entity';
import { HttpStatus } from '@nestjs/common';
import { UserService } from 'src/modules/user/user.service';
import { CreateUserInput } from 'src/modules/user/schemas/inputs/createUser.input';
...
describe('User module integration', () => {
  ...
  describe('UserService', () => {
    describe('create', () => {
      it('should hash password and persist user correctly', async () => {
        ...
        expect(userInDb?.password).not.toBe(input.password);
  ...
  describe('UserRepository', () => {
    describe('create', () => {
      const newUser: CreateUserPersistence = {
        email: 'insert@me.com  ',
        password: 'hashed_password',
        lastname: 'Me',
        firstname: 'Insert',
      ...
      it('should persist a user in the database and return a UserEntity', async () => {
        ...
        expect(userInDb?.password).toBe(newUser.password);
